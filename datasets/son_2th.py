...
def _process_utterance(out_dir, wav_path, text, hparams):
    ...
    if hparams['trim_silence']:  # hparams['trim_silen.' True
    ...
    if mel_frames > hparams.max_mel_frames and hparams.clip_mels_length:   # hparams['max_mel_fram.' 1000, hparams['clip_mels_leng.' True
        return None
    ...
    if hparams.use_lws:    # hparams['use_l.' False
